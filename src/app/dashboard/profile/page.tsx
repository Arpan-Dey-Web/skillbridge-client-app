      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
        ...
        <SpotlightCard className="md:col-span-8 p-10 border-border bg-card/50">
          <div className="flex items-center justify-between mb-8">
            ...
            <Award className="text-amber-500/40 size-6" />
          </div>
...
function InfoTile({ label, value }: { label: string; value: string }) {
  return (
    <div className="group p-5 bg-secondary/30 border border-border rounded-[1.5rem] hover:bg-secondary/50 transition-all">
...
function ActionCard({ icon, title, status, statusColor }: any) {
  return (
    <SpotlightCard className="p-5 flex items-center justify-between border-border bg-card/50 group">
      <div className="flex items-center gap-4">
        <div className="p-2.5 rounded-xl bg-secondary text-amber-500 group-hover:bg-amber-500/10 transition-colors">
          {icon}
        </div>
